...
def hash_mp_additionally(password_hash: str, salt: str) -> str:
    ...
    # ----------------additionally hash password "NUMBER_OF_HASH_ITERATIONS" times with salt-----------------------
    additionaly_hashed_master_password = hashlib.pbkdf2_hmac(
        hash_name="sha512",
        password=converted_to_bytes_password_hash,
        salt=converted_to_bytes_salt,
        iterations=NUMBER_OF_HASH_ITERATIONS,
        dklen=32,
    )
